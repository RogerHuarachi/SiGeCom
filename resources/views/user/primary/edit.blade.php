<div class="modal fade text-dark" id="businessEdit{{ $primary->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('businesses.update', $primary->id) }}" method="POST">
                {{ csrf_field() }}
                {{ @method_field('PUT') }}
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select form-control-border" name="client_id" required>
                                        <option value="{{ $primary->client->id }}">{{ $primary->client->name }} {{ $primary->client->lastName }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    data-dropdown-css-class="select2-primary" style="width: 100%;" name="caedec_id" required>
                                        <option value="{{ $primary->caedec->id }}">{{ $primary->caedec->code }} {{ $primary->caedec->description }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    placeholder="Nombre" name="activity" value="{{ $primary->activity }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border"
                                    onkeyup="javascript:this.value=this.value.toUpperCase();"
                                    placeholder="Codigo" name="profession" value="{{ $primary->profession }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select form-control-border" name="responsable" required>
                                        <option>{{ $primary->responsable }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    placeholder="Codigo" name="experience" value="{{ $primary->experience }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-border"
                                    placeholder="Nombre" name="antiquity" value="{{ $primary->antiquity }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
