            ...
            <div class="card">
                <div class="card-header bg-info p-1 pl-2 pr-2">
                    <h4 class="card-title">
                        ...
                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                        <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#childCreate">
            ...
            <div class="card">
                <div class="card-header bg-info p-1 pl-2 pr-2">
                    <h4 class="card-title">
                        ...
                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                            @if (!$payment)
                                <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#paymentCreate">
                                    <i class="fas fa-plus"></i>
                                </button>
                            @endif
                            @if ($payment)
                                <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#paymentEdit{{ $payment->id }}">
            ...
            <div class="card">
                <div class="card-header bg-info p-1 pl-2 pr-2">
                    <h4 class="card-title">
                        ...
                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                            <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#debtCreate">
                                <i class="fas fa-plus"></i>
                            </button>
                        @endif
                    </h4>
            ...
            <div class="card">
                <div class="card-header bg-info p-1 pl-2 pr-2">
                    <h4 class="card-title">
                        MUB
                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                            <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#mubCreate">
                                <i class="fas fa-plus"></i>
                            </button>
                        @endif
                    </h4>
            ...
            <div class="card">
                <div class="card-header bg-info p-1 pl-2 pr-2">
                    <h4 class="card-title">
                        ...
                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                            @if (!$cmub)
                                <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#cmubCreate">
                                    <i class="fas fa-plus"></i>
                                </button>
                            @endif
                            @if ($cmub)
                                <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#cmubEdit{{ $cmub->id }}">
                                    <i class="fas fa-pen"></i>
                                </button>
            ...
            <div class="card">
                <div class="card-header bg-info p-1 pl-2 pr-2">
                    <h4 class="card-title">
                        ...
                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                            <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#ppsifCreate">
                                <i class="fas fa-plus"></i>
                            </button>
                        @endif
                    </h4>
            ...
            <div class="card">
                <div class="card-header bg-info p-1 pl-2 pr-2">
                    <h4 class="card-title">
                        ...
                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                            @if (!$cdg)
                                <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#cdgCreate">
                                    <i class="fas fa-plus"></i>
                                </button>
                            @endif
                            @if ($cdg)
                                <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#cdgEdit{{ $cdg->id }}">
                                    <i class="fas fa-pen"></i>
                                </button>
            ...
            <div class="card">
                <div class="card-header bg-info p-1 pl-2 pr-2">
                    <h4 class="card-title">
                        ...
                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                            <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#oiCreate">
                                <i class="fas fa-plus"></i>
                            </button>
                        @endif
                    </h4>
                            ...
                            <tbody>
                                ...
                                <tr class="bg-secondary">
                                    <td>
                                        ...
                                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                                            <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#acnCreate">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        @endif
                                    </td>
                                ...
                                <tr class="bg-secondary">
                                    <td>
                                        ...
                                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                                            <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#afnCreate">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        @endif
                                    </td>
                                ...
                                <tr class="bg-secondary">
                                    <td>
                                        ...
                                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                                            <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#oanCreate">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        @endif
                                    </td>
                                ...
                                <tr class="bg-secondary">
                                    <td>
                                        ...
                                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                                            <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#afCreate">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        @endif
                                    </td>
                                ...
                                <tr class="bg-secondary">
                                    <td>
                                        ...
                                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                                            <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#oafCreate">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        @endif
                                    </td>
