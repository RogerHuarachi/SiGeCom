            ...
            <div class="card">
                <div class="card-header bg-info p-1 pl-2 pr-2">
                    <h4 class="card-title">
                        ...
                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                            @if (!$dge)
                                <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#dgeCreate">
                                    <i class="fas fa-plus"></i>
                                </button>
                            @endif
                            @if ($dge)
                                <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#dgeEdit{{ $dge->id }}">
            ...
            <div class="card">
                <div class="card-header bg-info p-1 pl-2 pr-2">
                    <h4 class="card-title">
                        Gastos Corrientes
                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                            <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#gcoCreate">
                                <i class="fas fa-plus"></i>
                            </button>
                        @endif
                    </h4>
            ...
            <div class="card">
                <div class="card-header bg-info p-1 pl-2 pr-2">
                    <h4 class="card-title">
                        ...
                        @if (Auth::user()->id == $client->folder->user->id && !$client->folder->state)
                            @if (!$cbal)
                                <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#cbalCreate">
                                    <i class="fas fa-plus"></i>
                                </button>
                            @endif
                            @if ($cbal)
                                <button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#cbalEdit{{ $cbal->id }}">
                                    <i class="fas fa-pen"></i>
                                </button>
