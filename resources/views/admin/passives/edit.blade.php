<div class="modal fade text-dark" id="passiveEdit{{ $passive->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('passives.update', $passive->id) }}" method="POST">
                {{ csrf_field() }}
                {{ @method_field('PUT') }}
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    name="client_id" required>
                                        <option value="{{ $passive->client->id }}">{{ $passive->client->name }} {{ $passive->client->lastName }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="select2-primary">
                                        ...
                                        data-dropdown-css-class="select2-primary" style="width: 100%;" name="creditor" required>
                                            <option>{{ $passive->creditor }}</option>
