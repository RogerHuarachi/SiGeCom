<div class="modal fade text-dark" id="ddgCreate">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('ddgs.store') }}" method="POST">
                {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    placeholder="Valor Comercial" name="vc" step=".01" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-border"
                                    placeholder="Valor Comercial" name="mc" step=".01" required>
                                </div>
                            </div>
                        </div>
                    </div>
