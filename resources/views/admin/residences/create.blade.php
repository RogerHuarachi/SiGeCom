<div class="modal fade text-dark" id="residenceCreate">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('residences.store') }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input id="domlat" type="text" class="form-control form-control-border"
                                    name="domlat" required>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label for="name">Logitud</label>
                                    <input id="domlon" type="text" class="form-control form-control-border"
                                    name="domlon" required>
                                </div>
                            </div>
                            <div class="col-md-2">
